<template>
    <button class="product-detail__btn-add-to-fav" @click="favorite">
        <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill="transparent"
                  :style="'stroke:'+ colorFavorite()"
...
export default {
    name: "BtnDetailFavoriteProductComponent",
    ...
    methods: {
        favorite() {
            this.$store.dispatch('favorite/favoriteProduct', {
