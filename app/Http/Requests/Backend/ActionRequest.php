...
class ActionRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'Необходимо ввести название акции',
            ...
            'detail_text.required' => 'Необходимо ввести детальный текст акции',
            'preview_text.required' => 'Необходимо ввести краткое описание акции',
        ];
    }
}
