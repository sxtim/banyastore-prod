    ...
    Route::middleware('role:admin')->group(function () {
        Route::prefix('backend')->name('backend.')->namespace('Backend')->group(function () {
            ...
            Route::prefix('product')->name('product.')->group(function () {
                ...
                Route::get('/download-products', [\App\Http\Controllers\Backend\ProductController::class, 'downloadProducts'])->name('download');
            });
...
//yml для яндекса
Route::get('/yml.xml', [\App\Http\Controllers\YmlController::class, 'catalog'])->name('catalog');

//Вебхук телеграм
Route::post('/telegram-webhook', [\App\Http\Controllers\Telegram\TelegramWebhookController::class, 'index'])->name('telegram.webhook.index');
...
//Route::get('/telegram-webhook-get', [\App\Http\Controllers\Telegram\TelegramWebhookController::class, 'getWebhook'])->name('telegram.webhook.get');
